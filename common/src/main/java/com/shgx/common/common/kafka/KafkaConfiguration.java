package com.shgx.common.common.kafka;
...
public class KafkaConfiguration {
    ...
    //创建TopicName为topic.business.shgx的Topic并设置分区数为2以及副本数为1
    @Bean
    public NewTopic initialTopic() {
        return new NewTopic("topic.business.shgx",2, (short) 1 );
    }
    ...
    public KafkaTemplate<Integer, String> defaultKafkaTemplate() {
        KafkaTemplate template = new KafkaTemplate<Integer, String>(producerFactory());
        template.setDefaultTopic("topic.business.shgx");
        return template;
    }
