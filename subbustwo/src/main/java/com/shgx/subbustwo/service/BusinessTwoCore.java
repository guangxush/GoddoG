 ...
 */
@Component
public class BusinessTwoCore {

    private static final Logger log= LoggerFactory.getLogger(AckListener.class);

    @Autowired
    private BusinessTwoService businessOneService;
    ...
    public void ackListener(ConsumerRecord record, Acknowledgment ack) {
        ...
        Object object = JSONObject.parseObject(record.value().toString(), BusinessTwoVO.class);
        BusinessTwoVO businessOneVO = new BusinessTwoVO();
        if(object!=null){
            try {
            ...
            BusinessTwo businessTwo = BusinessTwo.builder()
                    .uid(businessOneVO.getUid())
                    .money(businessOneVO.getMoney())
                    .status(businessOneVO.getStatus())
                    .build();
            businessOneService.saveBusinessTwo(businessTwo);
        }
        ack.acknowledge();
    }
}
